...
import { MOCK_PRODUCTS, getWhatsAppLink, VIDEOS } from '../constants';
        ...
        <div ref={shopRef} className="py-32 px-6 max-w-7xl mx-auto space-y-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 pt-10">
                {MOCK_PRODUCTS.map((product, idx) => (
                    <div key={product.id} className="stagger-child product-card group">
                        <ImageCard 
                        ...
                        <div className="p-6 space-y-4 bg-[#0B0F0B] rounded-b-3xl">
                            <div className="flex justify-between items-start">
                                <div>
                                    ...
                                    <p className="text-[#B8C0B8] text-sm mt-1">{product.size}</p>
                                </div>
